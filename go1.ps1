...
# --- 配置 ---
$RepositoryUrl = "https://github.com/jia6261/mc-g1-lancher" # 假设的 GitHub 仓库地址
$ZipDownloadUrl = "https://github.com/jia6261/mc-g1-lancher/blob/main/final_launcher_package%20(1).zip" # 假设的 ZIP 下载地址
